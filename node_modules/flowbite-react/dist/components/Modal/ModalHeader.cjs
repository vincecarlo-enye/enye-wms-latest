...
const ModalHeader = React.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { ref, className: tailwindMerge.twMerge(theme$1.base, popup && theme$1.popup, className), ...restProps, children: [
    ...
    dismissible && /* @__PURE__ */ jsxRuntime.jsx("button", { "aria-label": "Close", className: theme$1.close.base, type: "button", onClick: onClose, children: /* @__PURE__ */ jsxRuntime.jsx(outlineXIcon.OutlineXIcon, { "aria-hidden": true, className: theme$1.close.icon }) })
  ] });
});
