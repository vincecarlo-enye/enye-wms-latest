...
import importedData from "../assets/js/ImportedPRF.json";
...
const ImportedPRF = () => {
  ...
  const [prfList] = useState(importedData);
        ...
        {filteredData.length === 0 ? (
          ...
          filteredData.map((item) => (
            <tr key={item.prfNo} className="hover:bg-orange-50 transition">
              <td className="px-4 py-3 text-sm font-medium text-gray-800">{item.prfNo}</td>
              ...
              <td className="px-4 py-3 text-sm text-gray-600">{item.clientName}</td>
              <td className="px-4 py-3 text-sm text-gray-600">{item.project}</td>
              <td className="px-4 py-3 text-sm text-gray-600">{item.poNo}</td>
