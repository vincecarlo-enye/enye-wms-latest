  ...
  const fetchPRF = async () => {
    try {
      ...
      const res = await PRFService.list({
        ...
        // NOTE: RequestedPRF is likely admin/approver view, so NO scope=me here.
        // You can add additional filters via query if needed.
      });
      ...
      console.error("Fetch requested PRF error:", error);
      setPrfList([]);
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <header className="flex justify-between items-center p-6 bg-white shadow-sm border-b">
        <h1 className="text-2xl font-semibold text-gray-800">Requested PRF</h1>
